...
### YOLOv8-based Multi-Class Detection System | 🏆
...
This project implements a **production-ready ADAS object detection system** specifically trained for **Indian road scenarios**, The system handles complex challenges unique to Indian traffic:
